...
public class RegelwerkGUI {
	...
	jlRegelwerk.setText("<html><h1 align=\"center\">Regeln</h1>" + "Jeder hat seine Schiffe in seinem Feld. "
		+ "<p>Du kannst die Schiffe des Gegners nicht sehen, und er deine auch nicht."
		+ " Mit einem Mausklick tickt man dann auf das gegnerische Feld."
		+ " Gibt es einen Treffer, dann wird der angezeigt, wenn nicht, gibt es nur ein Loch im Wasser."
		+ " Gewonnen hat der, der alle gegnerischen Schiffe versenkt hat.</p><br/>"
		+ " Es gibt folgende Schiffe: </html>");
